        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Sercom / Ubah</h6>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ url('sercom/' . $data->id . '/update')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sercom_name" value="{{ $data->sercom_name }}" id="sercom_name" class="form-control form-control-alternative">
                            @error('sercom_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="sercom_code" value="{{ $data->sercom_code }}" id="sercom_code" class="form-control form-control-alternative">
                            @error('sercom_code')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="sercom_pic" value="{{ $data->sercom_pic }}" id="sercom_pic" class="form-control form-control-alternative">
                        </div>
                        <div class="form-group">
                            <label for="sercom_phone">Telepon</label>
                            <input type="number" name="sercom_phone" value="{{ $data->sercom_phone }}" id="sercom_phone" class="form-control form-control-alternative">
                        </div>
                        <div class="form-group">
                            <label for="sercom_email">Email</label>
                            <input type="email" name="sercom_email" id="sercom_email" value="{{ $data->sercom_email }}" class="form-control form-control-alternative">
                        </div>
                        <div class="form-group">
                            <label for="sercom_address">Alamat</label>
                            <textarea name="sercom_address" id="sercom_address" cols="10" rows="5" class="form-control form-control-alternative">{{ $data->sercom_address }}</textarea>
                        </div>
                        <div class="form-group">
