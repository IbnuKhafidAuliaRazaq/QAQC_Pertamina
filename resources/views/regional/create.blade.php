    ...
    <div class="card-inner">
        <form action="{{ url('regional') }}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <input type="text" name="regional_name" id="regional_name" class="form-control form-control-sm">
                    @error('regional_name')
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <input type="text" name="regional_alias" id="regional_alias" class="form-control form-control-sm">
