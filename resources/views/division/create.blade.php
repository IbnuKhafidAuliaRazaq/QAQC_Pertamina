        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Divisi / Tambah</h6>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ url('division') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="division_code" id="division_code" placeholder="Kode Divisi" class="form-control form-control-alternative">
                            @error('division_code')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="division_name" placeholder="Nama Divisi" id="division_name" class="form-control form-control-alternative">
                            @error('division_name')
                                <small class="text-danger"> {{ $message }} </small>
                            @enderror
                        </div>
