    ...
    <div class="card-inner">
        <form action="{{ url('division/' . $division->id . '/update')}}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <input type="number" value="{{ $division->division_code }}" name="division_code" id="division_code" class="form-control form-control-sm">
                    @error('division_code')
            ...
            <div class="form-group row">
                ...
                <div class="col-9">
                    <input type="text" name="division_name" value="{{ $division->division_name }}" id="division_name" class="form-control form-control-sm">
                    @error('division_name')
                        <small class="text-danger"> {{ $message }} </small>
                    @enderror
                </div>
